  ...
  return (
    <footer className="py-12 text-gray-700">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              ...
              <li>
                <Link to="/forgot-password" className="hover:text-blue-600 transition">
                  Forgot Password
                </Link>
              </li>
            </ul>
          ...
          {/* Get Involved */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-gray-900">Get Involved</h3>
            <p className="text-gray-600 mb-6">
              Have questions, feedback, or ideas to share? We'd love to hear
              from you. Let's collaborate to bring more color to the world!
            </p>
            <Link
              to="/support"
        ...
        {/* Bottom Row */}
        <div className="flex flex-col md:flex-row items-center justify-between text-center text-sm text-gray-500">
          <p>&copy; 2024 PaletteBloom. All rights reserved. - Made with ❤️ by Joseph Robinson</p>
        </div>
      </div>
    </footer>
  );
